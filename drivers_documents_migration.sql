...
ALTER TABLE Drivers
  ...
  ADD COLUMN voidedCheckDocumentPath VARCHAR(500) NULL,
  ADD COLUMN factoringCompanyDocumentPath VARCHAR(500) NULL;
...
CREATE INDEX idx_drivers_voided_check_document_path ON Drivers (voidedCheckDocumentPath);
CREATE INDEX idx_drivers_factoring_company_document_path ON Drivers (factoringCompanyDocumentPath);
